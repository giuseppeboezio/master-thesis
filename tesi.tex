...
\begin{document}
    ...
    \input{./sections/2_0_background_notions.tex}
    \input{./sections/3_0_clp_2p_kt.tex}
    \input{./sections/4_0_labeled_prolog.tex}
    \input{./sections/5_0_clp_labeled_prolog.tex}
